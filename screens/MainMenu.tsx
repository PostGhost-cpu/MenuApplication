...
const MainMenu = () => (
  <View style={styles.container}>
    ...
    <FlatList
      ...
      contentContainerStyle={{ paddingBottom: 180 }} // leave space for positioned Tab
    />

    {/* position Tab above the native bottom zone so it's closer to the list */}
...
const styles = StyleSheet.create({
  ...
  menuimg: { width: 56, height: 56, borderRadius: 28, overflow: 'hidden', marginRight: 12, borderWidth: 1,
    borderColor: '#000' },
  ...
  pillMain: { backgroundColor: '#4E6E33' },
  ...
  description: { fontSize: 12, color: '#000', marginTop: 6, lineHeight: 16 },
  ...
  // Tab container moved up from bottom
  tabWrap: {
    position: 'absolute',
    left: 12,
    right: 12,
    bottom: 120,     // sits above the bottom; adjust if needed
    alignItems: 'center',
  },

  // existing filter styles kept (unused here)
  bottomFilterBar: { position: 'absolute', left: 12, right: 12, bottom: 18, height: 62, borderRadius: 28, backgroundColor: '#F7B2A0', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 18, shadowColor: '#000', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 6 },
  filterLabel: { fontSize: 16, fontWeight: '700', color: '#4B2E2A' },
  filterSheet: { backgroundColor: '#FFF6DB', padding: 18, borderTopLeftRadius: 18, borderTopRightRadius: 18, shadowColor: '#000', shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 8 },
  filterTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 },
  filterTitle: { fontSize: 18, fontWeight: '800', color: '#4B2E2A' },
  applyButton: { marginTop: 18, alignSelf: 'center', backgroundColor: '#3C231C', paddingHorizontal: 40, paddingVertical: 12, borderRadius: 28 },
  applyButtonText: { color: '#FFF6DB', fontWeight: '800', fontSize: 16 },
  mutedNote: { fontSize: 11, color: '#8A7B6F' },
});
