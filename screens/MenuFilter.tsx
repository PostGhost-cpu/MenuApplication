...
const countIf = (arr?: ItemShape[], predicate?: (i: ItemShape) => boolean) =>
  arr ? arr.filter(predicate || (() => true)).length : 0;
        ...
        <View style={styles.courseRow}>
          {(['All', 'Starters', 'Mains', 'Desserts'] as Course[]).map(c => (
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <Text style={[styles.coursePillText, course === c && styles.coursePillTextActive]}>
                {c}
